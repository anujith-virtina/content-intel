...
- Arrow: inline SVG, `fill:#43627f` (slate — different from link blue `#00a0e2`), `position:absolute;left:0;top:8px`, inside `<span aria-hidden="true">`
